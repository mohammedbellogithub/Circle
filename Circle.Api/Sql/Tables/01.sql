...
CREATE TABLE [Business] (
    ...
    CONSTRAINT [FK_Business_AppUsers_UserAccountId] FOREIGN KEY ([UserAccountId]) REFERENCES [AppUsers] ([Id]) ON DELETE CASCADE
);
GO
...
VALUES ('773a3af2-cd9f-4f65-869f-0cfdc1e1589e', N'52a505de7c8f460e8b077f068f4c87df', NULL, NULL, CAST(1 AS bit), NULL, NULL, N'SYS_ADMIN', N'SYS_ADMIN'),
('ca7061a2-138c-45b7-870c-699caa9ca99b', N'4c6c992309dc4d4289f2bc1612ef20ec', NULL, NULL, CAST(1 AS bit), NULL, NULL, N'FRONTDESK', N'FRONTDESK'),
('cc785f2a-2c0a-4648-87b7-a500084a2c1a', N'de8e4409562f42c8abb253d603c435f3', NULL, NULL, CAST(1 AS bit), NULL, NULL, N'ADMIN', N'ADMIN'),
('cf185b00-652d-4c52-a3fb-4c94cb794718', N'f84021bed1bb4623ad904081ca31d161', NULL, NULL, CAST(1 AS bit), NULL, NULL, N'DEFAULT', N'DEFAULT');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'ConcurrencyStamp', N'CreatedBy', N'CreatedOn', N'IsInBuilt', N'ModifiedBy', N'ModifiedOn', N'Name', N'NormalizedName') AND [object_id] = OBJECT_ID(N'[AppRoles]'))
...
VALUES ('1743b5bd-1eb1-45b3-9630-99596b17cf53', 0, CAST(1 AS bit), N'f3611cf8-249c-49ae-8ad9-fc0527003f12', NULL, '2022-10-15T00:00:00.0000000', NULL, NULL, NULL, N'mohammedbello678@gmail.com', CAST(1 AS bit), N'Mohammed', NULL, CAST(0 AS bit), NULL, '2022-10-15T00:00:00.0000000', N'Bello', CAST(0 AS bit), NULL, NULL, NULL, NULL, N'MOHAMMEDBELLO678@GMAIL.COM', N'MOHAMMEDBELLO678@GMAIL.COM', N'AQAAAAEAACcQAAAAECN+j+6LCr0gErfxuXtJ7jG3d9fYyTLmpOOd3FkuVsvE2Btv8FyTA7WlFvQSf+361g==', N'09025055210', CAST(1 AS bit), NULL, NULL, N'318338a4-8f26-47d7-bb01-66b8784aeae6', NULL, CAST(0 AS bit), NULL, N'mohammedbello678@gmail.com', NULL, NULL),
('50b70c44-9eb7-4549-9a48-7d37809b7d8e', 0, CAST(1 AS bit), N'a62b3d3f-a9a4-481c-9e02-64bfc60f1b7b', NULL, '2022-10-15T00:00:00.0000000', NULL, NULL, NULL, N'system@innercircle.com', CAST(1 AS bit), N'John', NULL, CAST(0 AS bit), NULL, '2022-10-15T00:00:00.0000000', N'Doe', CAST(0 AS bit), NULL, NULL, NULL, NULL, N'SYSTEM@INNERCIRCLE.COM', N'SYSTEM@INNERCIRCLE.COM', N'AQAAAAEAACcQAAAAEKXK+IbyILb3/SzsnMuXLUh3lOiNXkx+cNNbwPhBdrCdyIZGSIPxLRWTDhr1VfTdEw==', N'08108565760', CAST(1 AS bit), NULL, NULL, N'3c147856-b944-49f7-8c03-86eab5feadac', NULL, CAST(0 AS bit), NULL, N'system@innercircle.com', NULL, NULL),
('96623538-0615-4d01-9023-7352bb4bb9c6', 0, CAST(1 AS bit), N'707a098b-9154-4226-a50b-1afcfe5b2300', NULL, '2020-10-15T00:00:00.0000000', NULL, NULL, NULL, N'frontdesk@innercircle.com', CAST(1 AS bit), N'babatunde', NULL, CAST(0 AS bit), NULL, '2020-10-15T00:00:00.0000000', N'Bello', CAST(0 AS bit), NULL, NULL, NULL, NULL, N'FRONTDESK@INNERCIRCLE.COM', N'FRONTDESK@INNERCIRCLE.COM', N'AQAAAAEAACcQAAAAENRkY8QZX9btIRk1m9oPB58J56gkoH107fPo2pPbjcRbT4w3eBka3QKPWTOVix3xgw==', N'+2349025055210', CAST(1 AS bit), NULL, NULL, N'81b94cda-96bb-43e0-ac86-6d4a3de474f9', NULL, CAST(0 AS bit), NULL, N'frontdesk@innercircle.com', NULL, NULL),
('ca5eb7a4-de1e-40a1-9c58-ac452112aa92', 0, CAST(1 AS bit), N'8234c470-f49f-4e28-b31d-64d7b05a5821', NULL, '2022-10-15T00:00:00.0000000', NULL, NULL, NULL, N'admin@innercircle.com', CAST(1 AS bit), N'', NULL, CAST(0 AS bit), NULL, '2022-10-15T00:00:00.0000000', N'Admin', CAST(0 AS bit), NULL, NULL, NULL, NULL, N'ADMIN@INNERCIRCLE.COM', N'ADMIN@INNERCIRCLE.COM', N'AQAAAAEAACcQAAAAEEp+1otSh+XCSP4whrc4WtswS+cCN4wjMYgpSp7UETLw6qB6xgtszqkutCKCkZ71Eg==', N'09025055210', CAST(1 AS bit), NULL, NULL, N'd2db0156-280e-4867-9795-8303362024dd', NULL, CAST(0 AS bit), NULL, N'admin@innercircle.com', NULL, NULL);
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'AccessFailedCount', N'Activated', N'ConcurrencyStamp', N'CreatedBy', N'CreatedOn', N'DeletedBy', N'DeletedOn', N'Department', N'Email', N'EmailConfirmed', N'FirstName', N'Gender', N'IsDeleted', N'IsPasswordDefault', N'LastLoginDate', N'LastName', N'LockoutEnabled', N'LockoutEnd', N'MiddleName', N'ModifiedBy', N'ModifiedOn', N'NormalizedEmail', N'NormalizedUserName', N'PasswordHash', N'PhoneNumber', N'PhoneNumberConfirmed', N'ProviderKey', N'RefreshToken', N'SecurityStamp', N'StaffNo', N'TwoFactorEnabled', N'Unit', N'UserName', N'UserType', N'UserTypeId') AND [object_id] = OBJECT_ID(N'[AppUsers]'))
...
VALUES ('fceb3aa6-c765-42ee-8f6b-c08c4439584f', N'https://twitter.com/Mohammed_kingin', N'The Circle management public profile', CAST(1 AS bit), N'Nigria', N'CIRCLE', N'https://twitter.com/Mohammed_kingin', '50b70c44-9eb7-4549-9a48-7d37809b7d8e');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'BannerPictureUrl', N'Bio', N'IsVerified', N'Location', N'ProfileName', N'ProfilePictureUrl', N'UserAccountId') AND [object_id] = OBJECT_ID(N'[UserProfile]'))
    SET IDENTITY_INSERT [UserProfile] OFF;
GO

CREATE INDEX [IX_Business_UserAccountId] ON [Business] ([UserAccountId]);
GO
...
VALUES (N'20230721202210_init', N'6.0.12');
GO
